...
export function Challenge(){
    return(
        ...
        <div className="flex flex-col  items-center justify-center   text-left mt-8  ml-8 mr-8 border-4 border-brand-500 py-4 ">
           ...
           <p className=" ">__Vou começar contando desde quando criei meu primeiro Portifólio com html e css puro,achei que tinha ficado maximo,<br></br>
               ...
               Também vi que que tinha suport para node.js depois de muitos estudos documentaçoês e tutoriais no youtub atravez da exten-<br></br>
               ssâo  engine EJS  é uma linguagem de modelagem simples que permite gerar marcaçâo HTML com JavaScript simples para usar é só<br></br>
               da npm install ejs -save na pasta do projeto e na extenssâo usar ejs ex: 'index.ejs' e tem que ter essa com figuraçâo no arquivo principal <br></br>
               onde roda sua aplicaçâo app.set('view engine', 'ejs') lembrando que para usar app. tem que extanciar o express desta maneira const app <br></br>
               ...
               o caminho do arquivo que vc quer renderizar em tela')) , para conseguir aplicar css tambem precisa de algumas configuraçoês precisa,que css esteje na pasta public<br></br>
                e no arquivo principal tem que ter essa, configuraçâo app.use(express.static('public')),vou deixar aqui o Link deste projeto em JavaScript puro hospedado na heroku<br></br>
